...
export function isValidMedicationType(value: string | null): value is SelectMedicationType {
  if (!value) return false;
  return Object.values(SelectMedicationType).includes(value as SelectMedicationType);
}
