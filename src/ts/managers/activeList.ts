...
import { DiseaseEditType, isKeyOf, isValidDiseaseEditKey, isValidMedicationKey, MedicationEditType, querySelectorEl } from "../types/types.js";
import { Disease, DiseaseEdit, InputDataDis, InputDataMed, Medication, MedicationEdit, MedicationType, Pill } from "../types/common";
import { formatDateRu, getTimeReception, isDatePassed, isDosageType, parseRussianDate } from "../core/timeUtils.js";
...
export class ActiveListManager {
                ...
                this.dataService.updateMedication(data.id, (med) => {
                    switch (key) {
                        ...
                        case 'stock':
                            ...
                            break
                        case 'time':
                            if (typeof data.newValue === 'string') med[key] = data.newValue.split(', ')
                            break
                        default:
                            break
                    }
    ...
    createEditContainerComponent(dis: Disease): string {
        return `
        <div class="edit">
    ...
    createEditMedicationComponent(med: MedicationType): string {
        return `
        <li class="edit__item">
