...
export function createMedicationComponent(med) {
    let dosType;
...
export function createEditMedicationComponent(med) {
    return `
        <li class="edit__item">
...
export function createEditAddComponent(type, powderType) {
    let html = '';
    switch (type) {
